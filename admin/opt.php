	...
	<div class="col-sm-10" align="center">
		...
		<div class="row myfs13">
			<div class="col" align="left" style="padding-top:8px"">
				&nbsp;옵션수 : <font color="red"><?=$opt_count ?></font>
			</div>
		...
		<table class="table table-sm table-bordered table-hover my-1">
			...
			<tr>
				...
				<td><?=$row["name"]; ?></td>
				<td>
					<a href="opt_edit.php?id=<?=$row["id"]; ?>" class="btn btn-sm mybutton-blue">수정</a>
					<a href="opt_delete.php?id=<?=$row["id"]; ?>" class="btn btn-sm mybutton-red" 
						onclick="javascript:return confirm('삭제할까요 ?');">삭제</a>				
				</td>
				<td>
					<a href="opts.php?id=<?=$row["id"]; ?>" class="btn btn-sm mybutton-gray">소옵션 편집</a>
				</td>
			</tr>
			<?
				}
